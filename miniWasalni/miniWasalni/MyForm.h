...
graph cities; //object from class
vector<string> nodes; //traversing graph
stack <string> BackTrack; //shortest path
...
namespace miniWasalni {
	...
	public:
		...
		{
			InitializeComponent();
			timer1->Stop(); //for the moving dog
		}
...
#pragma endregion
		 //Next Button for entering edges
...
private: System::Void btnBacktoMain_Click(System::Object^  sender, System::EventArgs^  e)
{
		 ...
		 //Back to Main Menu from Shortest Path Panel
private: System::Void button1_Click_2(System::Object^  sender, System::EventArgs^  e)
{
			 ...
			 pnlDisplay->Visible = false;
			 pnlMainMenu->Visible = true;
			 pic_car->Left -= 499; //return dog to initial position
			 txt_shortestDest->Clear();
			 txt_shortestSrc->Clear();
			 cbxShortestPath->Text = "";
}
		  //Display Button in Main Menu
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) 
{
		  ...
		  //Back to Main Menu Button from Update Panel
...
private: System::Void btn_UpdatePath_Click(System::Object^  sender, System::EventArgs^  e)
{
		 ...
		 //Update Graph button in Main Menu
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e)
{
		 ...
		 //delete Graph button in Main Menu
private: System::Void button5_Click(System::Object^  sender, System::EventArgs^  e) 
{
			 cities.deleteGraph();
			 if (MessageBox::Show("Graph deleted successfully.\nDo you want to add another a graph?", "Suggestion", MessageBoxButtons::YesNo, MessageBoxIcon::Question) == System::Windows::Forms::DialogResult::Yes)
			 {
         ...
         //Done editing Button in each panel of graph update
...
private: System::Void btn_findShortest_Click(System::Object^  sender, System::EventArgs^  e) 
{
			 ...
			 else
			 {
				 ...
				 else
				 {
					 ...
					 timer1->Start(); //dog starts moving
...
private: System::Void btn_BFS_Click(System::Object^  sender, System::EventArgs^  e) 
{
		 ...
		 //Moving dog in Shortest Path Panel
private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e)
{
			 pic_car->Left += 10;
			 if (pic_car->Location.X >= 650) //reached destination
			 {
				 timer1->Stop();
			 }
 }
...
{
			 if (cbxShortestPath->Text == "Path between two cities") //Dijkstra or Bellman Algorithm
			 {
				 txt_shortestDest->Clear();
				 txt_shortestSrc->Clear();
				 label6->Visible = true;
		 ...
		 //Delete city button in Update Graph
private: System::Void btn_DeleteCity_Click(System::Object^  sender, System::EventArgs^  e) 
{
		 ...
		 //Add city button in Update Graph
